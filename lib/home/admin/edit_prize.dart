...
class Pay_Win extends StatefulWidget {
  String quiz_id,userid,username;
 Pay_Win({super.key,required this.userid,required this.quiz_id,required this.username});

  @override
  State<Pay_Win> createState() => _Pay_WinState();
}

class _Pay_WinState extends State<Pay_Win> {
  @override
                  ...
                  try {
                    ...
                    try {
                      await FirebaseFirestore.instance
                          ...
                          .doc(widget.userid)
                          .collection('Scores')
                          .doc(widget.quiz_id).update({
                        "prizewin": prize.text,
                      });
                      Send.message(context, "User History Changed", true);
                    } catch (e) {
                      Send.message(context, "$e", false);
                    }
