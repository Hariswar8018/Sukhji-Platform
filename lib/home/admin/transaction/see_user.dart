...
class SeeUser extends StatelessWidget {
  String find;
  SeeUser({super.key,required this.find});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("About User",style: TextStyle(color: Colors.white),),
      ),
      body:StreamBuilder(
        stream: FirebaseFirestore.instance.collection('users').where("uid",isEqualTo: find).snapshots(),
